...
// given error, calculate/approximate J_R^{-1}
...
// edge between 2 Lie algebra vertex
class EdgeSE3LieAlgebra : public g2o::BaseBinaryEdge<6, SE3d, VertexSE3LieAlgebra, VertexSE3LieAlgebra> {
public:
    EIGEN_MAKE_ALIGNED_OPERATOR_NEW

    // error calculation, same in slambook14
...
int main(int argc, char *argv[]) {
    if (argc != 2) {
        cout << "usage: pose_graph_g2o_lie_algebra sphere.g2o" << endl;
        return 1;
    }
    ifstream fin(argv[1]);
    if (!fin) {
    ...
    // fake SE3 vertex and edges to let g2o_viewer recognize.
